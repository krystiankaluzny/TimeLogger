    ...
    ElevatedCard(
        ...
        Row(
            ...
            TextFiledWithPicker(
                ...
                onDismiss -> DatePickerModal(onDateSelected = onDateSelected, onDismiss = onDismiss)
            }

            Spacer(Modifier.width(16.dp))

            TextFiledWithPicker(
                initTime.format(timeFormatter),
                modifier = Modifier.weight(1f)) {
                onDismiss -> TimePickerDialog(initTime = initTime, onTimeSelected = onTimeSelected, onDismiss = onDismiss)
            }
        }
    }
}
