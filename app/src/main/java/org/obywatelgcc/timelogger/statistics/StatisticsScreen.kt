...
import org.obywatelgcc.timelogger.statistics.StatisticsAction.ShowNextRange
import org.obywatelgcc.timelogger.statistics.StatisticsAction.ShowPreviousRange
...
fun StatisticsScreen() {
    ...
    if (initialized) {
        Column(horizontalAlignment = Alignment.CenterHorizontally) {
            ...
            TimeRangeSliderView(timeRange, timeRangeType, viewModel::onAction)
...
fun TimeRangeSliderView(
    ...
    Row(
        ...
        IconButton(onClick = { onAction(ShowPreviousRange) }) {
        ...
        IconButton(onClick = { onAction(ShowNextRange) }) {
